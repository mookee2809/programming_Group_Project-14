        ...
        if(chart==1)
        {
            switch (infor)
            {
                case 1:
                    ...
                    display.displayAfterCheckingNewCase(DataTest);
                    break;
                case 2:
                    System.out.println("__________________________________________");
                    display.displayAfterCheckingNewDeath(DataTest);
                    break;
                case 3:
                    System.out.println("__________________________________________");
                    display.displayAfterCheckingVaccinated(DataTest);
                    break;
                default:
